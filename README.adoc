...
First download wanted versions of jla_01, rlp_01, syslog-java-client, tls-channel and slf4j from the following urls:
...
https://mvnrepository.com/artifact/com.github.marianobarrios/tls-channel[tls-channel]

https://mvnrepository.com/artifact/org.slf4j/slf4j-api[slf4j]
